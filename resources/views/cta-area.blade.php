<div class="flex flex-col py-8 gap-4 justify-center items-center">
    <div class="flex flex-col md:flex-row gap-4 items-center justify-center">
        ...
        <a href="{{ config('mine.links.blog') }}" target="_blank">
            <img class="w-12 h-12" src="{{ Vite::asset('resources/images/blog.png') }}" />
        </a>

        <a href="mailto:{{ config('mine.email') }}" target="_blank">
            <svg class="w-12 h-12 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
